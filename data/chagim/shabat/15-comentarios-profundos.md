# Comentários Profundos — PaRDeS

**title:** Comentários PaRDeS
**order_num:** 15
**level_pardes:** ["peshat", "remez", "drash", "sod"]
**is_premium:** true

---

O Zohar III, 152a ensina que a Toráh tem **corpo** (Peshat), **vestes** (Remez), **alma** (Drash) e **alma da alma** (Sod). Apresentamos o Shabat nos quatro níveis.
